...
INSERT INTO usuarios(DNI, NOMBRE_USUARIO, APELLIDO_USUARIO, PASSWORD, EMAIL_USUARIO,INSTITUTO_ID) VALUES('52907600X', 'diego', 'BELLO', '$2a$10$f4y.a1iHQ0H18aE0C099junFj2Csst/bjTaQ9oKvumB0QHVF.Hq9i', 'DIEGO@DIEGO.COM',1);
INSERT INTO usuarios(DNI, NOMBRE_USUARIO, APELLIDO_USUARIO, PASSWORD, EMAIL_USUARIO,INSTITUTO_ID) VALUES('52984600X', 'steven', 'FIRU', '$2a$10$M0b4mj7r8s6KW7ap94p72ui9S8BJitVkAKIrRUbr2qXkXOAHjA6eC', 'FIRU@LAY.COM',1);

INSERT INTO ROLES(nombre) VALUES('ROLE_USER');
INSERT INTO ROLES(nombre) VALUES('ROLE_ADMIN');

INSERT INTO `usuarios_roles` (id_usuario, id)VALUES(1,1);
INSERT INTO `usuarios_roles` (id_usuario, id)VALUES(2,1);
INSERT INTO `usuarios_roles` (id_usuario, id)VALUES(2,2);